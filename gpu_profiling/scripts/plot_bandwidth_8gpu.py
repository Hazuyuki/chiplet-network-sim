#!/usr/bin/env python3
"""
Plot bandwidth vs data size for 8 GPU NCCL All-Reduce experiment
"""
...
bandwidths = [21.02, 59.85, 100.29, 145.80, 164.65, 173.62]  # GB/s
times = [0.100, 0.140, 0.335, 0.921, 3.261, 12.369]  # ms
...
ax1.set_title('8 GPU NCCL All-Reduce Bandwidth', fontsize=14)
...
ax2.set_title('8 GPU NCCL All-Reduce Latency', fontsize=14)
...
plt.tight_layout()
plt.savefig('/share_data/zhuyu/chiplet-network-sim/gpu_profiling/results/bandwidth_8gpu.png', dpi=150, bbox_inches='tight')
plt.savefig('/share_data/zhuyu/chiplet-network-sim/gpu_profiling/results/bandwidth_8gpu.pdf', bbox_inches='tight')

print("Plot saved to:")
print("  - /share_data/zhuyu/chiplet-network-sim/gpu_profiling/results/bandwidth_8gpu.png")
print("  - /share_data/zhuyu/chiplet-network-sim/gpu_profiling/results/bandwidth_8gpu.pdf")
